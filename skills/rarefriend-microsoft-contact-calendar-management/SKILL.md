---
name: rarefriend-microsoft-contact-calendar-management
description: >
...
- **Outlook email search** — list and search your Outlook inbox, cross-reference email threads with CRM notes. Install `rarefriend-microsoft-email`.
